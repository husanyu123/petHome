...
- (void)layoutUI{
    ...
    if (!_sendBtn) {
        ...
        [_sendBtn setTitleColor:ZXColor(204, 204, 204) forState:UIControlStateNormal];
    ...
    if (!_contentBgView) {
        ...
        _contentBgView.backgroundColor = ZXColor(241, 242, 244);
...
- (void)resetView{
    ...
    [self.sendBtn setTitleColor:ZXColor(204, 204, 204) forState:UIControlStateNormal];
...
//    CGFloat height = CGRectGetHeight(textView.frame);
    ...
    if (textView.text.length>0) {
        ...
        [self.sendBtn setTitleColor:ZXColor(66, 189, 86) forState:UIControlStateNormal];
    }else{
        self.sendBtn.userInteractionEnabled = NO;
        [self.sendBtn setTitleColor:ZXColor(204, 204, 204) forState:UIControlStateNormal];
    }
