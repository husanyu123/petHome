...
- (void)layoutUI{
    ...
    if (!_headImageView) {
        ...
        [_headImageView setImage:[UIImage imageNamed:@"Mask"]];
...
//        _titleLab.textColor = RGBHexColor(0x333333, 1);
        _titleLab.textColor = ZXColor(255, 255, 255);
...
//        _contentLab.textColor = RGBHexColor(0x333333, 1);
        _contentLab.textColor = ZXColor(255, 255, 255);
    ...
    if (!_replyNameLab) {
        ...
        _replyNameLab.textColor = RGBA(150, 150, 150, 1);
    ...
    if (!_replyContentLab) {
        ...
        _replyContentLab.textColor = RGBA(150, 150, 150, 1);
...
- (void)configData:(id)data{
    ...
    CGFloat contentHeight =[self.contentLab.text heightWithFont:[UIFont systemFontOfSize:13] constrainedToWidth:WIDTH-28-7-18-12];
