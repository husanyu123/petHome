...
- (void)layoutUI{
    ...
    if (!_headerView) {
        _headerView = [[ZMCusCommentListTableHeaderView alloc] initWithFrame:CGRectMake(0, 0, WIDTH, 70)];
        @weakify(self)
        ...
        _headerView.backgroundColor=ZXColor(17, 16, 15);
    ...
    if (!_tableView) {
        ...
        _tableView.backgroundColor = ZXColor(17, 16, 15);
    ...
    if (!_bottomView) {
        ...
        _bottomView.backgroundColor= ZXColor(0, 0, 0);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row==1) {
        ...
        cell.contentView.backgroundColor=ZXColor(17, 16, 15);
        [cell configData:nil];
        return cell;
    }else{
